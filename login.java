...
//swing is class
package mypackages;
import javax.swing.*;//helps for outputing it contains joptionpane.showmesagedialog which helps to dispslay message as an alert
import java.sql.*;
...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jexit, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 530, 100, -1));

        jlogin.setBackground(new java.awt.Color(0, 0, 51));
        jlogin.setFont(new java.awt.Font("Footlight MT Light", 1, 14));
        ...
        jPanel2.add(jregister, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 430, 150, -1));
        ...
        admin.setForeground(new java.awt.Color(102, 255, 0));
        admin.setText("Log in as Admin");
        admin.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(204, 204, 204)));
        admin.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                adminMouseClicked(evt);
            }
        });
        jPanel2.add(admin, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, 120, 30));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 0, 430, 760));

        java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit().getScreenSize();
        setBounds((screenSize.width-1232)/2, (screenSize.height-800)/2, 1232, 800);
...
// TODO add your handling code here:
    ...
    try{
        /*
         ...
         2.Connection URL: The connection URL for the mysql database is jdbc:mysql://localhost:3306/library where jdbc is the API, mysql is the database, 
         3.localhost is the server name on which mysql is running, we may also use IP address, 3306 is the port number and sonoo is the database name. 
...
// TODO add your handling code here:
    ...
    Class.forName("com.mysql.jdbc.Driver");
         ...
         String sql="Select * from libraryadmins where admin_ID=? and Password=?";
         //The PreparedStatement interface is a subinterface of Statement. It is used to execute parameterized query.
         //As you can see, we are passing parameter (?) for the values. Its value will be set by calling the setter methods of PreparedStatement.
         //executequery is used to execute SELECT query. It returns the object of ResultSet.
         PreparedStatement pst= con.prepareStatement(sql);
